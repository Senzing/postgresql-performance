...
CREATE TABLE RES_FEAT_EKEY_0_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 0) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_EKEY_1_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 1) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_EKEY_2_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 2) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_EKEY_3_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 3) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_EKEY_4_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 4) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_EKEY_5_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 5) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_EKEY_6_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 6) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_EKEY_7_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 7) WITH (FILLFACTOR=75);
...
-- Includes are helpful if you are doing a lof of read-only queries.  Otherwise it causes a log of extra writing in loads.
...
CREATE TABLE RES_FEAT_STAT_0_NEW PARTITION OF RES_FEAT_STAT_NEW FOR VALUES WITH (modulus 8, remainder 0) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_STAT_1_NEW PARTITION OF RES_FEAT_STAT_NEW FOR VALUES WITH (modulus 8, remainder 1) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_STAT_2_NEW PARTITION OF RES_FEAT_STAT_NEW FOR VALUES WITH (modulus 8, remainder 2) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_STAT_3_NEW PARTITION OF RES_FEAT_STAT_NEW FOR VALUES WITH (modulus 8, remainder 3) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_STAT_4_NEW PARTITION OF RES_FEAT_STAT_NEW FOR VALUES WITH (modulus 8, remainder 4) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_STAT_5_NEW PARTITION OF RES_FEAT_STAT_NEW FOR VALUES WITH (modulus 8, remainder 5) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_STAT_6_NEW PARTITION OF RES_FEAT_STAT_NEW FOR VALUES WITH (modulus 8, remainder 6) WITH (FILLFACTOR=75);
CREATE TABLE RES_FEAT_STAT_7_NEW PARTITION OF RES_FEAT_STAT_NEW FOR VALUES WITH (modulus 8, remainder 7) WITH (FILLFACTOR=75);
...
CREATE TABLE RES_ENT_0 PARTITION OF RES_ENT_NEW FOR VALUES WITH (modulus 4, remainder 0) WITH (FILLFACTOR=75);
CREATE TABLE RES_ENT_1 PARTITION OF RES_ENT_NEW FOR VALUES WITH (modulus 4, remainder 1) WITH (FILLFACTOR=75);
CREATE TABLE RES_ENT_2 PARTITION OF RES_ENT_NEW FOR VALUES WITH (modulus 4, remainder 2) WITH (FILLFACTOR=75);
CREATE TABLE RES_ENT_3 PARTITION OF RES_ENT_NEW FOR VALUES WITH (modulus 4, remainder 3) WITH (FILLFACTOR=75);
...
CREATE TABLE DSRC_RECORD_0 PARTITION OF DSRC_RECORD_NEW FOR VALUES WITH (modulus 4, remainder 0) WITH (FILLFACTOR=75);
CREATE TABLE DSRC_RECORD_1 PARTITION OF DSRC_RECORD_NEW FOR VALUES WITH (modulus 4, remainder 1) WITH (FILLFACTOR=75);
CREATE TABLE DSRC_RECORD_2 PARTITION OF DSRC_RECORD_NEW FOR VALUES WITH (modulus 4, remainder 2) WITH (FILLFACTOR=75);
CREATE TABLE DSRC_RECORD_3 PARTITION OF DSRC_RECORD_NEW FOR VALUES WITH (modulus 4, remainder 3) WITH (FILLFACTOR=75);
...
CREATE TABLE RES_REL_EKEY_0 PARTITION OF RES_REL_EKEY_NEW FOR VALUES WITH (modulus 4, remainder 0) WITH (FILLFACTOR=75);
CREATE TABLE RES_REL_EKEY_1 PARTITION OF RES_REL_EKEY_NEW FOR VALUES WITH (modulus 4, remainder 1) WITH (FILLFACTOR=75);
CREATE TABLE RES_REL_EKEY_2 PARTITION OF RES_REL_EKEY_NEW FOR VALUES WITH (modulus 4, remainder 2) WITH (FILLFACTOR=75);
CREATE TABLE RES_REL_EKEY_3 PARTITION OF RES_REL_EKEY_NEW FOR VALUES WITH (modulus 4, remainder 3) WITH (FILLFACTOR=75);
...
CREATE TABLE RES_RELATE_0 PARTITION OF RES_RELATE_NEW FOR VALUES WITH (modulus 4, remainder 0) WITH (FILLFACTOR=75);
CREATE TABLE RES_RELATE_1 PARTITION OF RES_RELATE_NEW FOR VALUES WITH (modulus 4, remainder 1) WITH (FILLFACTOR=75);
CREATE TABLE RES_RELATE_2 PARTITION OF RES_RELATE_NEW FOR VALUES WITH (modulus 4, remainder 2) WITH (FILLFACTOR=75);
CREATE TABLE RES_RELATE_3 PARTITION OF RES_RELATE_NEW FOR VALUES WITH (modulus 4, remainder 3) WITH (FILLFACTOR=75);
