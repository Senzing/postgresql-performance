...
CREATE TABLE OBS_ENT_0_NEW PARTITION OF OBS_ENT_NEW FOR VALUES WITH (modulus 4, remainder 0) WITH (FILLFACTOR=50);
CREATE TABLE OBS_ENT_1_NEW PARTITION OF OBS_ENT_NEW FOR VALUES WITH (modulus 4, remainder 1) WITH (FILLFACTOR=50);
CREATE TABLE OBS_ENT_2_NEW PARTITION OF OBS_ENT_NEW FOR VALUES WITH (modulus 4, remainder 2) WITH (FILLFACTOR=50);
CREATE TABLE OBS_ENT_3_NEW PARTITION OF OBS_ENT_NEW FOR VALUES WITH (modulus 4, remainder 3) WITH (FILLFACTOR=50);
