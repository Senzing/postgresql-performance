...
CREATE TABLE RES_FEAT_EKEY_0_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 0) WITH (FILLFACTOR=50);
CREATE TABLE RES_FEAT_EKEY_1_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 1) WITH (FILLFACTOR=50);
CREATE TABLE RES_FEAT_EKEY_2_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 2) WITH (FILLFACTOR=50);
CREATE TABLE RES_FEAT_EKEY_3_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 3) WITH (FILLFACTOR=50);
CREATE TABLE RES_FEAT_EKEY_4_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 4) WITH (FILLFACTOR=50);
CREATE TABLE RES_FEAT_EKEY_5_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 5) WITH (FILLFACTOR=50);
CREATE TABLE RES_FEAT_EKEY_6_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 6) WITH (FILLFACTOR=50);
CREATE TABLE RES_FEAT_EKEY_7_NEW PARTITION OF RES_FEAT_EKEY_NEW FOR VALUES WITH (modulus 8, remainder 7) WITH (FILLFACTOR=50);
